...
class DespuesBaresScreen extends StatefulWidget {
  const DespuesBaresScreen({super.key});

  @override
  State<DespuesBaresScreen> createState() => _DespuesBaresScreenState();
}

class _DespuesBaresScreenState extends State<DespuesBaresScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = '';

  static const List<_LugarData> todosLosLugares = [
    _LugarData('Theatron', 'assets/images/theatron.jpg', 4.6477, -74.0559,
        'Discoteca', Icons.nightlife),
    _LugarData('Sonora Social Club', 'assets/images/sonora.jpg', 4.6421,
        -74.0571, 'Bar', Icons.local_bar),
    _LugarData('Octava', 'assets/images/octava.jpg', 4.6380, -74.0600,
        'Discoteca', Icons.nightlife),
    _LugarData('Karaoke Box', 'assets/images/karaoke_box.png', 4.6600, -74.0550,
        'Karaoke', Icons.mic),
    _LugarData('Armenia Pub', 'assets/images/armenia_pub.png', 4.6200, -74.0800,
        'Eventos', Icons.event),
    _LugarData('La Villa Bar', 'assets/images/la_viila_gastrobar.png', 4.6350,
        -74.0650, 'Bar', Icons.local_bar),
    _LugarData('Video Club', 'assets/images/video_club.jpg', 4.6520, -74.0580,
        'Discoteca', Icons.nightlife),
    _LugarData('Capital Drinks', 'assets/images/karaoke_box.png', 4.6660,
        -74.0540, 'Karaoke', Icons.mic),
    _LugarData('La Casa de la Salsa', 'assets/images/la_casa_de_la_salsa.jpg',
        4.6420, -74.0650, 'Eventos', Icons.event),
    _LugarData('El Candelario', 'assets/images/el_calendario.jpg', 4.5950,
        -74.0740, 'Bar', Icons.local_bar),
  ];
  ...
  void _navegarAlMapa(
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (c) => BaresYDiscotecasScreen(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      endDrawer: const AppDrawer(pantallaActual: AppDrawer.despuesBares),
      body: Builder(
                              ...
                              Container(
                                  ...
                                  child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: 'Buscar bares, discotecas...',
                                        hintStyle: TextStyle(
                                            fontSize: 13,
                                            color: dark
                                                ? Colors.grey[400]
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: _DespuesBaresDialog.amarillo,
                                            borderRadius:
