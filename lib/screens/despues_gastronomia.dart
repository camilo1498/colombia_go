...
class DespuesGastronomiaScreen extends StatefulWidget {
  const DespuesGastronomiaScreen({super.key});

  @override
  State<DespuesGastronomiaScreen> createState() =>
      _DespuesGastronomiaScreenState();
}

class _DespuesGastronomiaScreenState extends State<DespuesGastronomiaScreen> {
  final TextEditingController _searchController = TextEditingController();
  String _searchQuery = '';

  static const List<_LugarData> todosLosLugares = [
    _LugarData('Andres Carne De Res', 'assets/images/andres_carne_de_res.jpg',
        4.6650, -74.0570, 'Restaurante típico', Icons.restaurant),
    _LugarData(
        'Capitalino Restaurante',
        'assets/images/capitalino_restaurant.jpg',
        4.6150,
        -74.0680,
        'Comida tradicional',
        Icons.local_dining),
    _LugarData('Hornitos', 'assets/images/hornitos.jpg', 4.6650, -74.0580,
        'Rest. Internacional', Icons.public),
    _LugarData('Central Cevicheria', 'assets/images/central_cevicheria.jpg',
        4.6400, -74.0620, 'Mariscos', Icons.set_meal),
    _LugarData('Plaza Paloquemao', 'assets/images/plaza_paloquemao.jpg', 4.6100,
        -74.0890, 'Mercado gastronómico', Icons.storefront),
    _LugarData('La Cabrera', 'assets/images/la_cabrera.jpg', 4.6750, -74.0550,
        'Zona gastronómica', Icons.place),
    _LugarData('Café San Alberto', 'assets/images/cafe_san_alberto.jpg', 4.6012,
        -74.0725, 'Café de especialidad', Icons.coffee),
    _LugarData('Juan Valdez Café', 'assets/images/juan_valdez.jpg', 4.6450,
        -74.0640, 'Café colombiano', Icons.coffee),
    _LugarData('Harry Sasson', 'assets/images/harry_sasson.jpg', 4.6564,
        -74.0584, 'Alta cocina', Icons.restaurant_menu),
    _LugarData('Mercado de Paloquemao', 'assets/images/plaza_paloquemao.jpg',
        4.6100, -74.0890, 'Mercado gastronómico', Icons.storefront),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      endDrawer: const AppDrawer(pantallaActual: AppDrawer.despuesGastro),
      body: Builder(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: _DespuesGastronomiaDialog
                                                .amarillo,
                                            borderRadius:
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('¿Quieres ver este restaurante en el mapa?',
                            style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.w700,
                                color: textColor)),
...
class _DespuesGastronomiaDialog {
  static const Color amarillo = Color(0xFFF5C400);
}
