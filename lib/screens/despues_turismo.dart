...
class DespuesTurismoScreen extends StatefulWidget {
  const DespuesTurismoScreen({super.key});

  @override
  State<DespuesTurismoScreen> createState() => _DespuesTurismoScreenState();
}

class _DespuesTurismoScreenState extends State<DespuesTurismoScreen> {
  ...
  static const List<_LugarData> todosLosLugares = [
    _LugarData('Parque Simón Bolívar', 'assets/images/parque_simon_bolivar.jpg',
        4.6580, -74.0940, 'Parque Natural', Icons.nature),
    ...
    _LugarData('Playa El Rodadero', 'assets/images/playa_rodadero.jpg', 11.2200,
        -74.1800, 'Playa', Icons.beach_access),
    _LugarData('Parque Nacional', 'assets/images/parque_nacional.jpg', 4.6250,
        -74.0700, 'Parque Natural', Icons.park),
    _LugarData('Amazonas', 'assets/images/amazonas.jpg', -4.2150, -69.9400,
        'Lugar y Pueblo', Icons.forest),
    _LugarData('Cartagena', 'assets/images/cartagena.jpg', 10.3910, -75.4794,
        'Lugar y Pueblo', Icons.location_city),
    _LugarData('Ciudad Perdida', 'assets/images/ciudad_perdida.jpg', 11.0390,
        -73.9250, 'Lugar y Pueblo', Icons.explore),
    _LugarData('Valle de Cocora', 'assets/images/cocora.jpg', 4.6380, -75.4977,
        'Lugar y Pueblo', Icons.park),
    _LugarData('Ráquira', 'assets/images/raquira.png', 5.5314, -73.6349,
        'Lugar y Pueblo', Icons.cottage),
    _LugarData('Parque Tayrona', 'assets/images/destino2_parque_tayrona.jpg',
        11.3150, -74.0270, 'Lugar y Pueblo', Icons.beach_access),
    ...
    _LugarData('Casa de Nariño', 'assets/images/casa_de_nariño.png', 4.5965,
        -74.0765, 'Monumento', Icons.account_balance),
    _LugarData('Playa Blanca', 'assets/images/playa_blanca.jpg', 10.2800,
        -75.7100, 'Playa', Icons.beach_access),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      endDrawer: const AppDrawer(pantallaActual: AppDrawer.despuesTurismo),
      body: Builder(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color:
                                                _DespuesTurismoDialog.amarillo,
                                            borderRadius:
